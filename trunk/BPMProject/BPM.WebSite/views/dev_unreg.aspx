<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dev_unreg.aspx.cs" Inherits="views_dev_unreg" CodePage="936" %>
...
<form id="form1" runat="server">
    <table cellpadding="0" cellspacing="0" class="Tbl_Title">
        <tr>
            <td  align="center" colspan ="2" class="Tbl_TD_Title">设备报废流程</td>
        </tr>
        <tr>
            <td  align="left" class="Tbl_TD_Title_Label">销账日期：</td>
            <td  align="left" class="Tbl_TD_Title_Txt">
                <span id="tb_devmng_out_time" class="Tbl_TD_TextBox"></span></td>
        </tr>
    </table>
