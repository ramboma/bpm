...
namespace ServiceStack.OrmLite
{
    public static class ReadConnectionExtensions
    {
        ...
        /// </summary>
        public static List<Into> Select<Into, From>(this IDbConnection dbConn, SqlExpression<From> expression,bool customizeSelect=false)
        {
            return dbConn.Exec(dbCmd => dbCmd.Select<Into, From>(expression,customizeSelect));
        }
